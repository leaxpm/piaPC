...
def main():
    ...
    if args.metadata:
        if args.link:
            ...
            metadataScrapper.Metadata(args.link)
        else:
        ...
        if args.public:
            ...
            autoNmap.exec(scan="public")
        elif args.private:
            logging.info("Nmap Scan Private Started")
            autoNmap.exec(scan="private")
        else:
            logging.warning("Falta de Argumentos")
        ...
        if args.host:
            if args.host and args.user and args.password:
                ...
                print(ftpScanner.dir(args.host,args.user,args.password,args.anonymous))
            elif args.anonymous:
                logging.info("FTP Dir Scanner Started")
                print(ftpScanner.dir(args.host,"","",args.anonymous))
        else:
            logging.warning("Falta de Argumentos")
        ...
        if args.organizacion and args.apiKey:
            ...
            hunter.main(args.apiKey,args.organizacion)
        else:
            logging.warning("Falta de Argumentos")
